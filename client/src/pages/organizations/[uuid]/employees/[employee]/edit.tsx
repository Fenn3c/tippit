...
export default function Organization({ employee }: Props) {
    ...
    const formik = useFormik(
        {
            initialValues,
            onSubmit: values => {
                axiosInstance.patch(`/api/organizations/employees/${employee.uuid}`, {
    ...
    return (
        <>
            <Layout title={'Изменение должности'}>
                ...
                <Card>
                    ...
                    <div className="flex flex-col gap-y-8">
                        ...
                        <Button onClick={() => formik.handleSubmit()} text='Сохранить изменения' disabled={!formik.isValid} />
